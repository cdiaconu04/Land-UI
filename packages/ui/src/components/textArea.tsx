...
export default function TextArea({ font = "", colour = "default", textColour = "default", border = {type: 2, colour: "black"}, placeholder = {placeholder: "Input", colour: "default"}, round = 1 }: InputProps) {
    return (
        <textarea
