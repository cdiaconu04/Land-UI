        ...
        <div className="bg-white grid grid-cols-5 gap-8 justify-between w-full">
            <div className="col-span-4 flex flex-col gap-10 min-w-full items-start justify-top">
                ...
                <div className="flex flex-col gap-2 w-full">
                    <p className="text-3xl text-gray-800"> Shadows </p>
                    <p className="text-lg text-gray-800"> Some LandUI components require you to pass a Shadow prop. This documentation will show you how to use it.</p>
                </div>

                <div className="flex flex-col gap-4 w-full">
                    <p className="text-2xl text-gray-800"> Shadow levels </p>
